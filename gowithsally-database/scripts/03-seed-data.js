...
db.users.insertOne({
  ...
  phone: "+212600000001",
  password: "$2b$10$8K2h3j4k5l6m7n8o9p0qrstuvwxyzABCDEF.abcdefghijklmnop", // hashed: admin2024
  role: "admin",
  avatar: null,
...
db.users.insertOne({
  ...
  phone: "+212600000002",
  password: "$2b$10$8K2h3j4k5l6m7n8o9p0qrstuvwxyzABCDEF.abcdefghijklmnop",
  role: "support",
  avatar: null,
...
for (let i = 0; i < 50; i++) {
  ...
  db.users.insertOne({
    ...
    email: email,
    phone: phone,
    password: "$2b$10$rKqmqF4vMGcxH7E6T2pZOeXbHN3aVqR5sWdFg8hJiKlMnOpQrStU", // hashed: password123
    role: "user",
    avatar: null,
...
for (let i = 0; i < 25; i++) {
  ...
  db.users.insertOne({
    ...
    email: email,
    phone: phone,
    password: "$2b$10$rKqmqF4vMGcxH7E6T2pZOeXbHN3aVqR5sWdFg8hJiKlMnOpQrStU",
    role: "driver",
